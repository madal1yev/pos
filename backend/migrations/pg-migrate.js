...
INSERT INTO products (category_id, name, product_code, barcode, brand, purchase_price, selling_price, stock_quantity, minimum_stock, unit, image_url, status)
SELECT * FROM (VALUES
...
) AS v(category_id, name, product_code, barcode, brand, purchase_price, selling_price, stock_quantity, minimum_stock, unit, image_url, status)
